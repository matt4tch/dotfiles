...
alias jqcsv='jq -r '\''(map(keys) | add | unique) as $keys | $keys, map([.[ $keys[] ]])[] | @csv'\'
alias jw='./node_modules/.bin/jest --runInBand --watch'
alias l='ls -lah'
alias la='ls -lAh'
alias ll='ls -lhtr'
alias ls='ls -G'
...
alias md='mkdir -p'
alias nodebug='NODE_OPTIONS=" --inspect-brk"'
alias pr='gh pr view --web'
alias psx='ps -ax -o comm='
alias rd=rmdir
alias repo='gh repo view --web'
alias resetdb='python manage.py db_local_restore -s demo -p demo -i --dynamic-demo-data --skip-pip'
alias run-help=man
alias runserver='python manage.py runserver_plus'
alias serve='python -m SimpleHTTPServer'
alias sp='python manage.py shell_plus --quiet-load'
alias syncdb='manage syncdb --migrate'
alias ts='./node_modules/.bin/ts-node --transpile-only'
alias undo='git reset --soft HEAD~1'
alias unstage='git reset HEAD'
alias up='docker-compose up -d python; docker-compose logs -f python'
...
ta() {
  if [ -n "$1" ]; then
    ...
    tmux attach -t "$(tmux list-sessions -F '#S' 2>/dev/null | head -n 1)"
  fi
}
...
tks() {
  ...
  fi 2>/dev/null || echo "No such tmux session"
}

# typst aliases
alias tc='typst compile'

# Zsh line key bindings
